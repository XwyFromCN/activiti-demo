package cn.guolf.activiti.SequentialProcess;
...
public class Sequential1 {
    ...
    public void deploy() {
        ...
        // 流程部署
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("Sequential1.bpmn")
                .deploy();
...
// 设置流程创建人
        ...
        ProcessInstance processInstance = ProcessUtills.runtimeService()
                .startProcessInstanceByKey("sequential_1", "Key001");
