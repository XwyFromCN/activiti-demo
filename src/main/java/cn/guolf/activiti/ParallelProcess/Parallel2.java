 ...
 * @Auther: xwy
 * @Date: 2019/9/5 16:02
 * @Description: 并行任务,并行节点没有设置完成条件，当所有并行任务完成后，并行节点完成
 */
public class Parallel2 {
    ...
    public void deploy(){
        ...
        // 流程部署
        Deployment deployment = repositoryService.createDeployment().addClasspathResource("Parallel2.bpmn")
                .deploy();
...
// 设置流程创建人
        ...
        ProcessInstance processInstance = runtimeService()
                .startProcessInstanceByKey("myProcess_2", "Key002");
